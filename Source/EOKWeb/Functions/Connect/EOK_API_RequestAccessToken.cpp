...
#include "EOK_API_RequestAccessToken.h"

UEOK_API_RequestAccessToken* UEOK_API_RequestAccessToken::RequestAccessToken(FString Authorization, FString ClientId,
...
{
	UEOK_API_RequestAccessToken* Node = NewObject<UEOK_API_RequestAccessToken>();
...
void UEOK_API_RequestAccessToken::Activate()
{
	Super::Activate();
	...
	HttpRequest->OnProcessRequestComplete().BindUObject(this, &UEOK_API_RequestAccessToken::OnResponseReceived);
