...
#include "EOK_API_RedeemEntitlements.h"

UEOK_API_RedeemEntitlements* UEOK_API_RedeemEntitlements::RedeemEntitlements(FString Authorization, FString IdentityId,
	TArray<FString> EntitlementIds, FString SandboxId)
{
	UEOK_API_RedeemEntitlements* Node = NewObject<UEOK_API_RedeemEntitlements>();
...
void UEOK_API_RedeemEntitlements::Activate()
{
	Super::Activate();
	...
	HttpRequest->OnProcessRequestComplete().BindUObject(this, &UEOK_API_RedeemEntitlements::OnResponseReceived);
