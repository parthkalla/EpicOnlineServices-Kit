...
#include "EOK_API_RemoveSanctions.h"

UEOK_API_RemoveSanctions* UEOK_API_RemoveSanctions::RemoveSanctions(FString Authorization, FString DeploymentId,
	TArray<FString> ReferenceIds, FString Justification)
{
	UEOK_API_RemoveSanctions* Proxy = NewObject<UEOK_API_RemoveSanctions>();
...
void UEOK_API_RemoveSanctions::Activate()
{
	Super::Activate();
	...
	HttpRequest->OnProcessRequestComplete().BindUObject(this, &UEOK_API_RemoveSanctions::OnResponseReceived);
