...
#include "EOK_API_UpdatingSanctions.h"

UEOK_API_UpdatingSanctions* UEOK_API_UpdatingSanctions::UpdatingSanctions(FString Authorization, FString DeploymentId, TArray<FEOK_SanctionPatchPayload> SanctionPatchPayload)
{
	UEOK_API_UpdatingSanctions* Proxy = NewObject<UEOK_API_UpdatingSanctions>();
...
void UEOK_API_UpdatingSanctions::Activate()
{
	Super::Activate();
	...
	HttpRequest->OnProcessRequestComplete().BindUObject(this, &UEOK_API_UpdatingSanctions::OnResponseReceived);
