...
#include "EOK_API_CreateSanctionAppeals.h"

UEOK_API_CreateSanctionAppeals* UEOK_API_CreateSanctionAppeals::CreateSanctionAppeals(FString Authorization,
	FString DeploymentId, FString ReferenceId, int32 Reason)
{
	UEOK_API_CreateSanctionAppeals* Proxy = NewObject<UEOK_API_CreateSanctionAppeals>();
...
void UEOK_API_CreateSanctionAppeals::Activate()
{
	Super::Activate();
	...
	HttpRequest->OnProcessRequestComplete().BindUObject(this, &UEOK_API_CreateSanctionAppeals::OnResponseReceived);
