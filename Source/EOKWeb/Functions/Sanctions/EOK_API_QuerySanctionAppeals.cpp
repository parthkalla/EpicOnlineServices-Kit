...
#include "EOK_API_QuerySanctionAppeals.h"

UEOK_API_QuerySanctionAppeals* UEOK_API_QuerySanctionAppeals::QuerySanctionAppeals(FString Authorization,
	FString DeploymentId, FString ReferenceId, FString Status, FString ProductUserId, int32 Limit, int32 Offset)
{
	UEOK_API_QuerySanctionAppeals* Node = NewObject<UEOK_API_QuerySanctionAppeals>();
...
void UEOK_API_QuerySanctionAppeals::Activate()
{
	Super::Activate();
	...
	HttpRequest->OnProcessRequestComplete().BindUObject(this, &UEOK_API_QuerySanctionAppeals::OnResponseReceived);
