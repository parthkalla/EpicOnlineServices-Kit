...
#include "EOK_API_CreateSanctions.h"

#include "JsonObjectConverter.h"

UEOK_API_CreateSanctions* UEOK_API_CreateSanctions::CreateSanctions(FString Authorization, FString DeploymentId,
                                                                    TArray<FEOK_SanctionPostPayload> Sanctions)
{
	UEOK_API_CreateSanctions* Proxy = NewObject<UEOK_API_CreateSanctions>();
...
void UEOK_API_CreateSanctions::Activate()
{
	Super::Activate();
	...
	HttpRequest->OnProcessRequestComplete().BindUObject(this, &UEOK_API_CreateSanctions::OnResponseReceived);
