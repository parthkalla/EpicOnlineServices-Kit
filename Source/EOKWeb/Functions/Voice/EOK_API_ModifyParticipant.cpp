...
#include "EOK_API_ModifyParticipant.h"

UEOK_API_ModifyParticipant* UEOK_API_ModifyParticipant::ModifyParticipant(FString Authorization, FString DeploymentId,
	FString RoomId, FString ProductUserId, bool bHardMuted)
{
	UEOK_API_ModifyParticipant* Proxy = NewObject<UEOK_API_ModifyParticipant>();
...
void UEOK_API_ModifyParticipant::Activate()
{
	Super::Activate();
	...
	HttpRequest->OnProcessRequestComplete().BindUObject(this, &UEOK_API_ModifyParticipant::OnResponseReceived);
