...
#include "EOK_API_FindPlayerReports.h"

UEOK_API_FindPlayerReports* UEOK_API_FindPlayerReports::FindPlayerReports(FString Authorization, FString DeploymentId,
...
{
	UEOK_API_FindPlayerReports* Proxy = NewObject<UEOK_API_FindPlayerReports>();
...
void UEOK_API_FindPlayerReports::Activate()
{
	Super::Activate();
	...
	HttpRequest->OnProcessRequestComplete().BindUObject(this, &UEOK_API_FindPlayerReports::OnResponseReceived);
