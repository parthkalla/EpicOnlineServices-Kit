...
class EOKShared_API FCallbackBase
{
public:
...
public:
	...
	TEOKGlobalCallback() = default;
#endif
	virtual ~TEOKGlobalCallback() = default;
...
private:
	...
	{
		TEOKGlobalCallback* CallbackThis = (TEOKGlobalCallback*)Data->ClientData;
		check(CallbackThis);
