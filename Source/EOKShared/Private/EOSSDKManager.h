...
struct FEOKPlatformHandle;

class FEOKSDKManager :
	public IEOSSDKManager,
	public FSelfRegisteringExec
{
public:
	FEOKSDKManager();
	virtual ~FEOKSDKManager();
	...
	virtual IEOKPlatformHandlePtr CreatePlatform(const FString& PlatformConfigName, FName InstanceName = NAME_None) override;
	virtual IEOKPlatformHandlePtr CreatePlatform(EOS_Platform_Options& PlatformOptions) override;
...
protected:
	...
	virtual IEOKPlatformHandlePtr CreatePlatform(const FEOSSDKPlatformConfig& PlatformConfig, EOS_Platform_Options& PlatformOptions);
	...
	friend struct FEOKPlatformHandle;
	...
	TMap<FString, TMap<FName, IEOKPlatformHandleWeakPtr>> PlatformHandles;
...
struct FEOKPlatformHandle : public IEOKPlatformHandle
{
	FEOKPlatformHandle(FEOKSDKManager& InManager, EOS_HPlatform InPlatformHandle)
		: IEOKPlatformHandle(InPlatformHandle), Manager(InManager)
	{
	}

	virtual ~FEOKPlatformHandle();
