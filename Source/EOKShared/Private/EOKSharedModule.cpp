...
IMPLEMENT_MODULE(FEOKSharedModule, EOKShared);

void FEOKSharedModule::StartupModule()
{
#if WITH_EOS_SDK	
	if (IsRunningCommandlet())
	{
		...
		UE_LOG(LogEOKSDK, Log, TEXT("IsRunningCommandlet=true, skipping EOSSDK initialization."))
		return;
	}
	...
	GConfig->GetArray(TEXT("EOKShared"), TEXT("ModulesToLoad"), ModulesToLoad, GEngineIni);
...
void FEOKSharedModule::ShutdownModule()
{
#if WITH_EOS_SDK
