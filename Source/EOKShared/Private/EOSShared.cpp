...
DEFINE_LOG_CATEGORY(LogEOKSDK);

FString EOK_LexToString(const EOS_EResult EosResult)
{
	return UTF8_TO_TCHAR(EOS_EResult_ToString(EosResult));
}

FString EOK_LexToString(const EOS_ProductUserId UserId)
{
	FString Result;
...
void EOK_LexFromString(EOS_ProductUserId& UserId, const TCHAR* String)
{
	UserId = EOS_ProductUserId_FromString(TCHAR_TO_UTF8(String));
}

FString EOK_LexToString(const EOS_EpicAccountId AccountId)
{
	FString Result;
...
const TCHAR* EOK_LexToString(const EOS_EApplicationStatus ApplicationStatus)
{
...
const TCHAR* EOK_LexToString(const EOS_EAuthTokenType AuthTokenType)
{
...
const TCHAR* EOK_LexToString(const EOS_EDesktopCrossplayStatus DesktopCrossplayStatus)
{
...
const TCHAR* EOK_LexToString(const EOS_EExternalAccountType ExternalAccountType)
{
...
const TCHAR* EOK_LexToString(const EOS_EFriendsStatus FriendStatus)
{
	switch (FriendStatus)
	{
...
const TCHAR* EOK_LexToString(const EOS_ELoginStatus LoginStatus)
{
	switch (LoginStatus)
	{
...
const TCHAR* EOK_LexToString(const EOS_ENetworkStatus NetworkStatus)
{
...
const TCHAR* EOK_LexToString(const EOS_Presence_EStatus PresenceStatus)
{
...
bool EOK_LexFromString(EOS_EExternalCredentialType& OutEnum, const TCHAR* InString)
{
...
bool EOK_LexFromString(EOS_EAuthScopeFlags& OutEnum, const TCHAR* InString)
{
...
bool EOK_LexFromString(EOS_ELoginCredentialType& OutEnum, const TCHAR* InString)
{
