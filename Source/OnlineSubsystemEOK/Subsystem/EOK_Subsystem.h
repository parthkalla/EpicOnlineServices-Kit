...
#endif
#include "EOK_Subsystem.generated.h"


UENUM(BlueprintType)
enum EEOKAttributeType
{
	String,
	Bool,
	Integer
...
struct FEOKAttribute
{
	GENERATED_BODY()

	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Epic Online Services-Kit V2")
	TEnumAsByte<EEOKAttributeType> AttributeType = EEOKAttributeType::String;
	...
	FEOKAttribute()
	{
		AttributeType = EEOKAttributeType::String;
		StringValue = "";
		BoolValue = false;
		IntValue = 0;
	}
	FVariantData GetVariantData() const
	{
		...
		{
		case EEOKAttributeType::String:
			VariantData.SetValue(StringValue);
			break;
		case EEOKAttributeType::Bool:
			VariantData.SetValue(BoolValue);
			break;
		case EEOKAttributeType::Integer:
	...
	FEOKAttribute(FVariantData VariantData)
	{		
		...
		case EOnlineKeyValuePairDataType::Bool:
			AttributeType = EEOKAttributeType::Bool;
			VariantData.GetValue(BoolValue);
			break;
		case EOnlineKeyValuePairDataType::Int32:
			AttributeType = EEOKAttributeType::Integer;
...
struct FOffersStruct
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "EOK Nodes")
	FString ItemID;
...
struct FSessionFindStruct
{
	...
	UPROPERTY(BlueprintReadWrite, Category="EOS Struct")
	TMap<FString, FEOKAttribute> SessionSettings = TMap<FString, FEOKAttribute>();
...
public:
	...
	FORCEINLINE bool operator==(const FEOKUniqueNetId& Other) const
	{
...
struct FEOK_Stats
{
	...
	UPROPERTY(BlueprintReadWrite, Category="EOK Struct")
	FString StatsName;
...
DECLARE_DYNAMIC_DELEGATE_TwoParams(FBP_GetStats_Callback, bool, bWasSuccess, const TArray<FEOK_Stats>&,Stats);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FBP_FriendInviteRecievedDelegate, const FEOKUniqueNetId&, LocalUserId, const FEOKUniqueNetId&, InvitedUserId);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FEOK_OnSessionUserInviteAccepted, bool, bWasSuccesfull, const FBlueprintSessionResult&, AcceptedSession);

UCLASS()
class OnlineSubsystemEOK_API UEOK_Subsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category="Epic Online Services-Kit V2 || Login")
	...
	UFUNCTION(BlueprintCallable,DisplayName="Create EOS Session", Category="Epic Online Services-Kit V2 || Sessions")
	...
	UFUNCTION(BlueprintCallable,DisplayName="Create EOS Lobby", Category="Epic Online Services-Kit V2 || Sessions")
	...
	UFUNCTION(BlueprintCallable, DisplayName="Find EOS Session", Category="Epic Online Services-Kit V2 || Sessions")
	...
	UFUNCTION(BlueprintCallable, DisplayName="Destroy EOS Session", Category="Epic Online Services-Kit V2 || Sessions")
	...
	UFUNCTION(BlueprintCallable, DisplayName="Join EOS Session", Category="Epic Online Services-Kit V2 || Sessions")
	...
	FEOKUniqueNetId GetUserUniqueID() const;
	...
	UFUNCTION(BlueprintPure, DisplayName="Get Product UserID", Category="Epic Online Services-Kit V2 || Extra")
	static FString GetProductUserID(const FEOKUniqueNetId& UniqueNetId);
	...
	UFUNCTION(BlueprintPure, DisplayName="Get Epic ID", Category="Epic Online Services-Kit V2 || Extra")
	static FString GetEpicID(const FEOKUniqueNetId& UniqueNetId);

	// This is a C++ method definition for unregistering Players into the session
	UFUNCTION(BlueprintCallable, DisplayName="Unregister Players", Category="Epic Online Services-Kit V2 || Sessions")
	void UnRegisterPlayer(FName SessionName);

	// This is a C++ method definition for registering Players into the session
	UFUNCTION(BlueprintCallable, DisplayName="Register Players", Category="Epic Online Services-Kit V2 || Sessions")
	void RegisterPlayer(FName SessionName, bool bWasInvited);
	
	// This is a C++ method definition for starting lobbies and sessions
	UFUNCTION(BlueprintCallable, DisplayName="Start EOS Session", Category="Epic Online Services-Kit V2 || Sessions")
	void StartSession(FName SessionName);

	// This is a C++ method definition for starting lobbies and sessions
	UFUNCTION(BlueprintCallable, DisplayName="End EOS Session", Category="Epic Online Services-Kit V2 || Sessions")
	...
	UFUNCTION(BlueprintCallable, Category="Epic Online Services-Kit V2 || Friend")
	bool ShowFriendUserInterface();

	//Stat Functions
	UFUNCTION(BlueprintCallable, Category="Epic Online Services-Kit V2 || Statistics")
	...
	UFUNCTION(BlueprintCallable, Category="Epic Online Services-Kit V2 || Data")
	...
	UFUNCTION(BlueprintCallable, Category="Epic Online Services-Kit V2 || Leaderboard")
	void GetLeaderboard(const FBP_GetFile_Callback& Result, FName LeaderboardName, int32 Rank, int32 Range);
	
	//This is a C++ method definition for finding Epic Online Services Sessions
	UFUNCTION(BlueprintCallable,DisplayName="Connect EOS And PlayFab", Category="Epic Online Services-Kit V2 || PlayFab")
	...
	UFUNCTION(BlueprintCallable, Category="Epic Online Services-Kit V2 || Store")
	...
	UFUNCTION(BlueprintCallable, Category="Epic Online Services-Kit V2 || Sessions")
	...
	FEOK_OnSessionUserInviteAccepted OnSessionUserInviteAccepted;
