...
#include "EOK_PresenceSubsystem.h"
...
FEOK_NotificationId UEOK_PresenceSubsystem::EOK_Presence_AddNotifyJoinGameAccepted(const FEOK_Presence_JoinGameAcceptedCallbackInfo& Callback)
{
	...
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get("EOK"))
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
		{
			...
			{
				if (UEOK_PresenceSubsystem* PresenceSubsystem = static_cast<UEOK_PresenceSubsystem*>(Data->ClientData))
				{
	...
	UE_LOG(LogEOK, Error, TEXT("EOK_Presence_AddNotifyJoinGameAccepted: OnlineSubsystemEOS is not valid"));
	return FEOK_NotificationId();
	
}

FEOK_NotificationId UEOK_PresenceSubsystem::EOK_Presence_AddNotifyOnPresenceChanged(
	const FEOK_Presence_OnPresenceChangedCallbackInfo& Callback)
{
	...
	UE_LOG(LogEOK, Error, TEXT("EOK_Presence_AddNotifyOnPresenceChanged: OnlineSubsystemEOS is not valid"));
	return FEOK_NotificationId();
}

TEnumAsByte<EEOK_Result> UEOK_PresenceSubsystem::EOK_Presence_CopyPresence(FEOK_EpicAccountId LocalUserId,
	FEOK_EpicAccountId TargetUserId, FEOK_Presence_Info& OutPresence)
{
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get("EOK"))
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
	...
	UE_LOG(LogEOK, Error, TEXT("EOK_Presence_CopyPresence: OnlineSubsystemEOS is not valid"));
	return EEOK_Result::EOS_NotFound;
}

TEnumAsByte<EEOK_Result> UEOK_PresenceSubsystem::EOK_Presence_CreatePresenceModification(FEOK_EpicAccountId LocalUserId,
	FEOK_HPresenceModification& OutPresenceModificationHandle)
{
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get("EOK"))
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
	...
	UE_LOG(LogEOK, Error, TEXT("EOK_Presence_CreatePresenceModification: OnlineSubsystemEOS is not valid"));
	return EEOK_Result::EOS_NotFound;
}

TEnumAsByte<EEOK_Result> UEOK_PresenceSubsystem::EOK_Presence_GetJoinInfo(FEOK_EpicAccountId LocalUserId,
	FEOK_EpicAccountId TargetUserId, FString& OutBuffer)
{
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get("EOK"))
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
	...
	UE_LOG(LogEOK, Error, TEXT("EOK_Presence_GetJoinInfo: OnlineSubsystemEOS is not valid"));
	return EEOK_Result::EOS_NotFound;
}

bool UEOK_PresenceSubsystem::EOK_Presence_HasPresence(FEOK_EpicAccountId LocalUserId, FEOK_EpicAccountId TargetUserId)
{
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get("EOK"))
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
	...
	UE_LOG(LogEOK, Error, TEXT("EOK_Presence_HasPresence: OnlineSubsystemEOS is not valid"));
	return false;
}

void UEOK_PresenceSubsystem::EOK_Presence_Info_Release(const FEOK_Presence_Info& PresenceInfo)
{
	EOS_Presence_Info ReleasePresenceInfo = PresenceInfo.Ref;
	EOS_Presence_Info_Release(&ReleasePresenceInfo);
}

void UEOK_PresenceSubsystem::EOK_Presence_RemoveNotifyJoinGameAccepted(FEOK_NotificationId InId)
{
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get("EOK"))
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
...
void UEOK_PresenceSubsystem::EOK_Presence_RemoveNotifyOnPresenceChanged(FEOK_NotificationId InId)
{
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get("EOK"))
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
...
TEnumAsByte<EEOK_Result> UEOK_PresenceSubsystem::EOK_PresenceModification_DeleteData(FEOK_HPresenceModification PresenceModificationHandle, const FEOK_PresenceModification_DataRecordId& Data, int32 Count)
{
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get("EOK"))
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
	...
	UE_LOG(LogEOK, Error, TEXT("EOK_PresenceModification_DeleteData: OnlineSubsystemEOS is not valid"));
	return EEOK_Result::EOS_NotFound;
}

void UEOK_PresenceSubsystem::EOK_PresenceModification_Release(FEOK_HPresenceModification PresenceModificationHandle)
{
	EOS_PresenceModification_Release(PresenceModificationHandle.Ref);
}

TEnumAsByte<EEOK_Result> UEOK_PresenceSubsystem::EOK_PresenceModification_SetData(
	FEOK_HPresenceModification PresenceModificationHandle, const FEOK_Presence_DataRecord& Data, int32 Count)
{
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get("EOK"))
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
	...
	UE_LOG(LogEOK, Error, TEXT("EOK_PresenceModification_SetData: OnlineSubsystemEOS is not valid"));
	return EEOK_Result::EOS_NotFound;
}

TEnumAsByte<EEOK_Result> UEOK_PresenceSubsystem::EOK_PresenceModification_SetJoinInfo(
	FEOK_HPresenceModification PresenceModificationHandle, const FString& JoinInfo)
{
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get("EOK"))
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
	...
	UE_LOG(LogEOK, Error, TEXT("EOK_PresenceModification_SetJoinInfo: OnlineSubsystemEOS is not valid"));
	return EEOK_Result::EOS_NotFound;
}

TEnumAsByte<EEOK_Result> UEOK_PresenceSubsystem::EOK_PresenceModification_SetRawRichText(
	FEOK_HPresenceModification PresenceModificationHandle, const FString& RichText)
{
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get("EOK"))
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
	...
	UE_LOG(LogEOK, Error, TEXT("EOK_PresenceModification_SetRawRichText: OnlineSubsystemEOS is not valid"));
	return EEOK_Result::EOS_NotFound;
}

TEnumAsByte<EEOK_Result> UEOK_PresenceSubsystem::EOK_PresenceModification_SetStatus(
	FEOK_HPresenceModification PresenceModificationHandle, TEnumAsByte<EEOK_Presence_EStatus> Status)
{
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get("EOK"))
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
	...
	UE_LOG(LogEOK, Error, TEXT("EOK_PresenceModification_SetStatus: OnlineSubsystemEOS is not valid"));
	return EEOK_Result::EOS_NotFound;
}
