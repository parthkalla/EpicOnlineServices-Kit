...
#include "EOK_Leaderboards_QueryLeaderboardUserScores.generated.h"

USTRUCT(BlueprintType)
struct FEOK_Leaderboards_QueryLeaderboardUserScoresOptions
{
	GENERATED_BODY()
	...
	FEOK_Leaderboards_QueryLeaderboardUserScoresOptions()
		: UserIds()
		, StatInfo()
		, StartTime(-1)
		, EndTime(-1)
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FEOK_Leaderboards_OnQueryLeaderboardUserScoresCompleteCallback, const TEnumAsByte<EEOK_Result>&, Result);

UCLASS()
class OnlineSubsystemEOK_API UEOK_Leaderboards_QueryLeaderboardUserScores : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()

public:
	//Query for a list of scores for a given list of users.
	UFUNCTION(BlueprintCallable, Category = "Epic Online Services-Kit V2 | SDK Functions | Leaderboards Interface", DisplayName = "EOS_Leaderboards_QueryLeaderboardUserScores")
	static UEOK_Leaderboards_QueryLeaderboardUserScores* EOK_Leaderboards_QueryLeaderboardUserScores(const FEOK_Leaderboards_QueryLeaderboardUserScoresOptions& Options);
	
	UPROPERTY(BlueprintAssignable, Category = "Epic Online Services-Kit V2 | SDK Functions | Leaderboards Interface")
	FEOK_Leaderboards_OnQueryLeaderboardUserScoresCompleteCallback OnCallback;
private:
	FEOK_Leaderboards_QueryLeaderboardUserScoresOptions Var_Options;
