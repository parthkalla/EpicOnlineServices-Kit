...
#include "EOK_Connect_TransferDeviceIdAccount.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FEOK_Connect_TransferDeviceIdAccount_Delegate, const FEOK_ProductUserId&, LocalUserId, TEnumAsByte<EEOK_Result>, Result);
UCLASS()
class OnlineSubsystemEOK_API UEOK_Connect_TransferDeviceIdAccount : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Epic Online Services-Kit V2 | SDK Functions | Connect Interface", DisplayName="EOS_Connect_TransferDeviceIdAccount")
	static UEOK_Connect_TransferDeviceIdAccount* EOK_Connect_TransferDeviceIdAccount(FEOK_ProductUserId PrimaryLocalUserId, FEOK_ProductUserId LocalUserId, FEOK_ProductUserId ProductUserIdToPreserve);

	UPROPERTY(BlueprintAssignable, Category = "Epic Online Services-Kit V2")
	FEOK_Connect_TransferDeviceIdAccount_Delegate OnCallback;
private:
	static void OnTransferDeviceIdAccountCallback(const EOS_Connect_TransferDeviceIdAccountCallbackInfo* Data);
	virtual void Activate() override;
	FEOK_ProductUserId Var_PrimaryLocalUserId;
	FEOK_ProductUserId Var_LocalUserId;
	FEOK_ProductUserId Var_ProductUserIdToPreserve;
};
