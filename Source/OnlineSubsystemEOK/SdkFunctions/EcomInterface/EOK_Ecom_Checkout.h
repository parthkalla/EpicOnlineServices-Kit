...
#include "EOK_Ecom_Checkout.generated.h"

USTRUCT(BlueprintType)
struct FEOK_Ecom_CheckoutOptions
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	TArray<FEOK_Ecom_CheckoutEntry> Entries;

	FEOK_Ecom_CheckoutOptions()
	{
		LocalUserId = FEOK_EpicAccountId();
		OverrideCatalogNamespace = "";
		EntryCount = 0;
		Entries = TArray<FEOK_Ecom_CheckoutEntry>();
	}
...
USTRUCT(BlueprintType)
struct FEOK_Ecom_CheckoutCallbackInfo
{
	GENERATED_BODY()
	...
	FEOK_Ecom_CheckoutCallbackInfo()
	{
	...
	FEOK_Ecom_CheckoutCallbackInfo(const EOS_Ecom_CheckoutCallbackInfo* Data)
	{
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FEOK_Ecom_CheckoutCallback, const FEOK_Ecom_CheckoutCallbackInfo&, Data);

UCLASS()
class OnlineSubsystemEOK_API UEOK_Ecom_Checkout : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface", DisplayName = "EOS_Ecom_Checkout")
	static UEOK_Ecom_Checkout* EOK_Ecom_Checkout(FEOK_Ecom_CheckoutOptions CheckoutOptions);
	
	UPROPERTY(BlueprintAssignable, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	FEOK_Ecom_CheckoutCallback OnCallback;
	
private:
	FEOK_Ecom_CheckoutOptions Local_CheckoutOptions;
