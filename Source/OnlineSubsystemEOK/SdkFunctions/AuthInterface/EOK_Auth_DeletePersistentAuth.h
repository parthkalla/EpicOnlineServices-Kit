...
#include "EOK_Auth_DeletePersistentAuth.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnDeletePersistentAuthCallback, TEnumAsByte<EEOK_Result>, ResultCode);

UCLASS()
class OnlineSubsystemEOK_API UEOK_Auth_DeletePersistentAuth : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "Epic Online Services-Kit V2 | SDK Functions | Auth Interface", DisplayName = "EOS_Auth_DeletePersistentAuth")
	static UEOK_Auth_DeletePersistentAuth* DeletePersistentAuth(FString RefreshToken);
