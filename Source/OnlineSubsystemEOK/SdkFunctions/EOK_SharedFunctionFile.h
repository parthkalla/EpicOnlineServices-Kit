...
#include "EOK_SharedFunctionFile.generated.h"

USTRUCT(BlueprintType)
struct FEOK_ProductUserId
{
	GENERATED_BODY()
...
public:
	FEOK_ProductUserId(): ProductUserIdBasic(nullptr)
	{
		ProductUserId = "";
	}

	FEOK_ProductUserId(EOS_ProductUserId InProductUserId)
	{
...
USTRUCT(BlueprintType)
struct FEOK_EpicAccountId 
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Auth Interface")
	FString EpicAccountId;
	
private:
	EOS_EpicAccountId Ref;
public:
	FEOK_EpicAccountId(): Ref(nullptr)
	{
		EpicAccountId = "";
	}

	FEOK_EpicAccountId(EOS_EpicAccountId InEpicAccountId)
	{
		Ref = InEpicAccountId;
...
UENUM(BlueprintType)
enum EOK_ELoginStatus
{
	EOK_LS_NotLoggedIn = 0 UMETA(DisplayName = "Not Logged In"),
	EOK_LS_UsingLocalProfile = 1 UMETA(DisplayName = "Using Local Profile"),
	EOK_LS_LoggedIn = 2 UMETA(DisplayName = "Logged In")
};

USTRUCT(BlueprintType)
struct FEOK_ContinuanceToken
{
	GENERATED_BODY()
...
public:
	FEOK_ContinuanceToken(): ContinuanceTokenBasic(nullptr)
	{
		ContinuanceToken = "";
	}

	FEOK_ContinuanceToken(EOS_ContinuanceToken InContinuanceToken)
	{
...
struct FEOK_NotificationId
{
	...
	FEOK_NotificationId(EOS_NotificationId InNotificationId)
	{
...
USTRUCT(BlueprintType)
struct FEOK_Connect_IdToken
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Connect Interface")
	FEOK_ProductUserId UserId;

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Connect Interface")
	FString Token;

	FEOK_Connect_IdToken()
	{
		UserId = FEOK_ProductUserId();
		Token = "";
	}

	FEOK_Connect_IdToken(EOS_Connect_IdToken InIdToken)
	{
...
UENUM(BlueprintType)
enum EEOK_EExternalCredentialType
{
	/**
	 ...
	 */
	EOK_ECT_EPIC = 0 UMETA(DisplayName = "Epic Games"),
	/**
	 ...
	 */
	EOK_ECT_STEAM_APP_TICKET = 1 UMETA(DisplayName = "Steam"),
	/**
	 ...
	 */
	EOK_ECT_PSN_ID_TOKEN = 2 UMETA(DisplayName = "PlayStation Network"),
	/**
	 ...
	 * Supported with EOS_Auth_Login, EOS_Connect_Login.
	 */
	EOK_ECT_XBL_XSTS_TOKEN = 3 UMETA(DisplayName = "Xbox Live"),
	/**
	 ...
	 * Supported with EOS_Connect_Login.
	 */
	EOK_ECT_DISCORD_ACCESS_TOKEN = 4 UMETA(DisplayName = "Discord"),
	/**
	 ...
	 * Supported with EOS_Connect_Login.
	 */
	EOK_ECT_GOG_SESSION_TICKET = 5 UMETA(DisplayName = "GOG Galaxy"),
	/**
	 ...
	 * Supported with EOS_Auth_Login, EOS_Connect_Login.
	 */
	EOK_ECT_NINTENDO_ID_TOKEN = 6 UMETA(DisplayName = "Nintendo"),
	/**
	 ...
	 * Supported with EOS_Auth_Login, EOS_Connect_Login.
	 */
	EOK_ECT_NINTENDO_NSA_ID_TOKEN = 7 UMETA(DisplayName = "Nintendo Service"),
	/**
	 * Uplay Access Token
	 */
	EOK_ECT_UPLAY_ACCESS_TOKEN = 8 UMETA(DisplayName = "Uplay"),
	/**
	 * OpenID Provider Access Token
	 *
	 * Supported with EOS_Connect_Login.
	 */
	EOK_ECT_OPENID_ACCESS_TOKEN = 9 UMETA(DisplayName = "OpenID Provider"),
	/**
	 ...
	 */
	EOK_ECT_DEVICEID_ACCESS_TOKEN = 10 UMETA(DisplayName = "Device ID"),
	/**
	 * Apple ID Token
	 *
	 * Supported with EOS_Connect_Login.
	 */
	EOK_ECT_APPLE_ID_TOKEN = 11,
	/**
	 * Google ID Token
	 *
	 * Supported with EOS_Connect_Login.
	 */
	EOK_ECT_GOOGLE_ID_TOKEN = 12 UMETA(DisplayName = "Google"),
	/**
	 ...
	 * Supported with EOS_Connect_Login.
	 */
	EOK_ECT_OCULUS_USERID_NONCE = 13 UMETA(DisplayName = "Oculus"),
	/**
	 ...
	 * Supported with EOS_Connect_Login.
	 */
	EOK_ECT_ITCHIO_JWT = 14 UMETA(DisplayName = "itch.io JWT"),
	/**
	 ...
	 * Supported with EOS_Connect_Login.
	 */
	EOK_ECT_ITCHIO_KEY = 15 UMETA(DisplayName = "itch.io Key"),
	/**
	 * Epic Games ID Token
	 *
	 ...
	 * Supported with EOS_Connect_Login.
	 */
	EOK_ECT_EPIC_ID_TOKEN = 16 UMETA(DisplayName = "Epic Games ID Token"),
	/**
	 * Amazon Access Token
	 *
	 * Supported with EOS_Connect_Login.
	 */
	EOK_ECT_AMAZON_ACCESS_TOKEN = 17 UMETA(DisplayName = "Amazon Access Token"),
	/**
	 ...
	 * @version 1.15.1+
	 */
	EOK_ECT_STEAM_SESSION_TICKET = 18 UMETA(DisplayName = "Steam Session Ticket"),
	/**
	 * VIVEPORT User Session Token
	 *
	 * Supported with EOS_Connect_Login.
	 */
	EOK_ECT_VIVEPORT_USER_TOKEN = 19 UMETA(DisplayName = "VIVEPORT User Token"),

};
UENUM(BlueprintType)
enum EEOK_EExternalAccountType
{
	/** External account is associated with Epic Games */
	EOK_EAT_EPIC = 0 UMETA(DisplayName = "Epic Games"),
	/** External account is associated with Steam */
	EOK_EAT_STEAM = 1 UMETA(DisplayName = "Steam"),
	/** External account is associated with PlayStation(TM)Network */
	EOK_EAT_PSN = 2 UMETA(DisplayName = "PlayStation Network"),
	/** External account is associated with Xbox Live */
	EOK_EAT_XBL = 3 UMETA(DisplayName = "Xbox Live"),
	/** External account is associated with Discord */
	EOK_EAT_DISCORD = 4	UMETA(DisplayName = "Discord"),
	/** External account is associated with GOG */
	EOK_EAT_GOG = 5 UMETA(DisplayName = "GOG"),
	/**
	 ...
	 */
	EOK_EAT_NINTENDO = 6 UMETA(DisplayName = "Nintendo"),
	/** External account is associated with Uplay */
	EOK_EAT_UPLAY = 7 UMETA(DisplayName = "Uplay"),
	/** External account is associated with an OpenID Provider */
	EOK_EAT_OPENID = 8 UMETA(DisplayName = "OpenID"),
	/** External account is associated with Apple */
	EOK_EAT_APPLE = 9 UMETA(DisplayName = "Apple"),
	/** External account is associated with Google */
	EOK_EAT_GOOGLE = 10 UMETA(DisplayName = "Google"),
	/** External account is associated with Oculus */
	EOK_EAT_OCULUS = 11 UMETA(DisplayName = "Oculus"),
	/** External account is associated with itch.io */
	EOK_EAT_ITCHIO = 12 UMETA(DisplayName = "itch.io"),
	/** External account is associated with Amazon */
	EOK_EAT_AMAZON = 13 UMETA(DisplayName = "Amazon"),
	/** External account is associated with Viveport */
	EOK_EAT_VIVEPORT = 14 UMETA(DisplayName = "Viveport"),
};



USTRUCT(BlueprintType)
struct FEOK_Connect_ExternalAccountInfo
{
	GENERATED_BODY()
	...
	FEOK_Connect_ExternalAccountInfo()
	{
		UserId = FEOK_ProductUserId();
		AccountId = "";
		DisplayName = "";
		LastLoginTime = 0;
		AccountType = EOK_EAT_EPIC;
	}
	FEOK_Connect_ExternalAccountInfo(EOS_Connect_ExternalAccountInfo InExternalAccountInfo)
	{
		...
		AccountType = static_cast<EEOK_EExternalAccountType>(InExternalAccountInfo.AccountIdType);
	}
...
USTRUCT(BlueprintType)
struct FEOK_Achievements_DefinitionV2
{
	GENERATED_BODY()
	
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Achievements Interface")
...
public:
	FEOK_Achievements_DefinitionV2(): bIsHidden(false), DefinitionRef(nullptr)
	{
	}

	FEOK_Achievements_DefinitionV2(EOS_Achievements_DefinitionV2 InDefinition)
	{
...
USTRUCT(BlueprintType)
struct FEOK_Achievements_PlayerStatInfo
{
	GENERATED_BODY()
	...
	FEOK_Achievements_PlayerStatInfo()
	{
		Name = "";
		CurrentValue = 0;
		ThresholdValue = 0;
	}
	FEOK_Achievements_PlayerStatInfo(EOS_Achievements_PlayerStatInfo InStatInfo)
	{
...
USTRUCT(BlueprintType)
struct FEOK_Achievements_PlayerAchievement
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Achievements Interface")
	TArray<FEOK_Achievements_PlayerStatInfo> StatInfo;
	...
	FEOK_Achievements_PlayerAchievement(): PlayerAchievementRef(nullptr)
	{
		AchievementId = "";
		Progress = 0;
		UnlockTime = 0;
		StatInfoCount = 0;
		StatInfo = TArray<FEOK_Achievements_PlayerStatInfo>();
		DisplayName = "";
		Description = "";
		IconURL = "";
		FlavorText = "";
	...
	FEOK_Achievements_PlayerAchievement(EOS_Achievements_PlayerAchievement InPlayerAchievement)
	{
...
USTRUCT(BlueprintType)
struct FEOK_Auth_IdToken
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Auth Interface")
	FEOK_EpicAccountId AccountId;
	...
	FEOK_Auth_IdToken(): TokenRef()
	{
		AccountId = FEOK_EpicAccountId();
		JsonWebToken = "";
	}

	FEOK_Auth_IdToken(EOS_Auth_IdToken InIdToken)
	{
		TokenRef = InIdToken;
...
UENUM(BlueprintType)
enum EEOK_EAuthTokenType
{
	EOK_ATT_Client = 0 UMETA(DisplayName = "Client"),
	EOK_ATT_User = 1 UMETA(DisplayName = "User")
};

USTRUCT(BlueprintType)
struct FEOK_Auth_Token
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Auth Interface")
	TEnumAsByte<EEOK_EAuthTokenType> AuthType;
	...
	FEOK_Auth_Token(): TokenRef()
	{
		...
		ExpiresIn = 0;
		ExpiresAt = "";
		AuthType = EOK_ATT_Client;
		RefreshToken = "";
		RefreshExpiresIn = 0;
		RefreshExpiresAt = "";
	}

	FEOK_Auth_Token(EOS_Auth_Token InToken): TokenRef()
	{
		TokenRef = InToken;
		...
		AuthType = static_cast<EEOK_EAuthTokenType>(InToken.AuthType);
...
struct FEOK_Auth_PinGrantInfo
{
	...
	FEOK_Auth_PinGrantInfo(): ExpiresIn(0), PinGrantInfo()
	{
		UserCode = "";
		VerificationURI = "";
	...
	FEOK_Auth_PinGrantInfo(EOS_Auth_PinGrantInfo InPinGrantInfo)
	{
...
UENUM(BlueprintType)
enum EEOK_ELinkAccountFlags
{
	EOK_LA_NoFlags = 0x0,
	EOK_LA_NintendoNsaId = 0x1
};

UENUM(BlueprintType)
enum EEOK_ELoginCredentialType
{
	//Login using account email address and password.
	EOK_LCT_Password = 0 UMETA(DisplayName = "Password"),
	...
	EOK_LCT_ExchangeCode = 1 UMETA(DisplayName = "Exchange Code"),
	...
	EOK_LCT_PersistentAuth = 2 UMETA(DisplayName = "Persistent Auth"),
	//Not supported. Superseded by EOS_LCT_ExternalAuth login method.
	EOK_LCT_DeviceCode = 3 UMETA(DisplayName = "Device Code"),
	//Login with named credentials hosted by the EOS SDK Developer Authentication Tool.
	EOK_LCT_Developer = 4 UMETA(DisplayName = "Developer"),
	...
	EOK_LCT_RefreshToken = 5 UMETA(DisplayName = "Refresh Token"),
	...
	EOK_LCT_AccountPortal = 6 UMETA(DisplayName = "Account Portal"),
...
struct FEOK_Auth_Credentials
{
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Auth Interface")
	TEnumAsByte<EEOK_ELoginCredentialType> Type;
	
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Auth Interface")
	TEnumAsByte<EEOK_EExternalCredentialType> ExternalType;

	FEOK_Auth_Credentials()
	{
		Id = "";
		Token = "";
		Type = EOK_LCT_Password;
		ExternalType = EOK_ECT_EPIC;
	}
...
USTRUCT(BlueprintType)
struct FEOK_Ecom_CatalogItemId 
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	FString Value;
	
	EOS_Ecom_CatalogItemId Ref;

	FEOK_Ecom_CatalogItemId(): Ref(nullptr)
	{
	}
	FEOK_Ecom_CatalogItemId(EOS_Ecom_CatalogItemId InCatalogItemId)
	{
		Ref = InCatalogItemId;
...
USTRUCT(BlueprintType)
struct FEOK_Ecom_EntitlementName 
{
	GENERATED_BODY()
	...
	FEOK_Ecom_EntitlementName(): Ref(nullptr)
	{
	}

	FEOK_Ecom_EntitlementName(EOS_Ecom_EntitlementName InEntitlementName)
	{
...
UENUM(BlueprintType)
enum EEOK_EEcomItemType
{
	//This entitlement is intended to persist.
	EOK_EIT_Durable = 0 UMETA(DisplayName = "Durable"),
	//This entitlement is intended to be transient and redeemed.
	EOK_EIT_Consumable = 1 UMETA(DisplayName = "Consumable"),
...
struct FEOK_Ecom_CatalogItem
{
	...
	//The ID of this item
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	FEOK_Ecom_CatalogItemId Id;

	//The entitlement name associated with this item
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	FEOK_Ecom_EntitlementName EntitlementName;
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	TEnumAsByte<EEOK_EEcomItemType> ItemType;
	...
	FEOK_Ecom_CatalogItem(): Ref()
	{
		CatalogNamespace = "";
		Id = FEOK_Ecom_CatalogItemId();
		EntitlementName = FEOK_Ecom_EntitlementName();
		TitleText = "";
		DescriptionText = "";
		LongDescriptionText = "";
		TechnicalDetailsText = "";
		DeveloperText = "";
		ItemType = EOK_EIT_Durable;
		EntitlementEndTimestamp = -1;
	}

	FEOK_Ecom_CatalogItem(EOS_Ecom_CatalogItem InCatalogItem)
	{
		Ref = InCatalogItem;
		...
		ItemType = static_cast<EEOK_EEcomItemType>(InCatalogItem.ItemType);
		EntitlementEndTimestamp = InCatalogItem.EntitlementEndTimestamp;
	}
};

USTRUCT(BlueprintType)
struct FEOK_Ecom_CatalogOfferId
{
	GENERATED_BODY()
	...
	FEOK_Ecom_CatalogOfferId(): CatalogOfferId(nullptr)
	{
		OfferId = "";
	}

	FEOK_Ecom_CatalogOfferId(EOS_Ecom_CatalogOfferId InCatalogOfferId)
	{
...
struct FEOK_Ecom_CatalogOffer
{
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	TEnumAsByte<EEOK_Result> PriceResult;
	...
	FEOK_Ecom_CatalogOffer(): Ref()
	{
		ServerIndex = 0;
		CatalogNamespace = "";
		Id = FEOK_Ecom_CatalogOfferId();
		TitleText = "";
		DescriptionText = "";
		LongDescriptionText = "";
		CurrencyCode = "";
		PriceResult = EEOK_Result::EOS_Canceled;
	...
	FEOK_Ecom_CatalogOffer(EOS_Ecom_CatalogOffer InCatalogOffer)
	{
		Ref = InCatalogOffer;
		...
		PriceResult = static_cast<EEOK_Result>(InCatalogOffer.PriceResult);
...
USTRUCT(BlueprintType)
struct FEOK_Ecom_CatalogRelease
{
	GENERATED_BODY()
	...
	FEOK_Ecom_CatalogRelease(EOS_Ecom_CatalogRelease InCatalogRelease)
	{
...
USTRUCT(BlueprintType)
struct FEOK_Ecom_CheckoutEntry
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	FEOK_Ecom_CatalogItemId OfferId;

	EOS_Ecom_CheckoutEntry Ref;
	FEOK_Ecom_CheckoutEntry(): Ref()
	{
	}

	FEOK_Ecom_CheckoutEntry(EOS_Ecom_CheckoutEntry InCheckoutEntry)
	{
		Ref = InCheckoutEntry;
...
USTRUCT(BlueprintType)
struct FEOK_Ecom_EntitlementId
{
	GENERATED_BODY()
	...
	FEOK_Ecom_EntitlementId(): Value(), Ref(nullptr)
	{
	}

	FEOK_Ecom_EntitlementId(EOS_Ecom_EntitlementId InEntitlementId)
	{
		Ref = InEntitlementId;
...
struct FEOK_Ecom_Entitlement
{
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	FEOK_Ecom_EntitlementId EntitlementId;

	//ID of the item associated with the offer which granted this entitlement
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	FEOK_Ecom_CatalogItemId CatalogItemId;
	...
	FEOK_Ecom_Entitlement(): ServerIndex(0), bRedeemed(false), EndTimestamp(-1), Ref()
	{
	}

	FEOK_Ecom_Entitlement(EOS_Ecom_Entitlement InEntitlement)
	{
		Ref = InEntitlement;
...
struct FEOK_Ecom_KeyImageInfo
{
	...
	FEOK_Ecom_KeyImageInfo(): Width(0), Height(0), Ref()
	{
		Type = "";
	}

	FEOK_Ecom_KeyImageInfo(EOS_Ecom_KeyImageInfo InKeyImageInfo)
	{
		Ref = InKeyImageInfo;
...
USTRUCT(BlueprintType)
struct FEOK_Ecom_HTransaction
{
	GENERATED_BODY()

	EOS_Ecom_HTransaction Ref;
	
	FEOK_Ecom_HTransaction(): Ref(nullptr)
	{
	}

	FEOK_Ecom_HTransaction(EOS_Ecom_HTransaction InHTransaction)
	{
		Ref = InHTransaction;
	}
...
UENUM(BlueprintType)
enum EEOK_EOwnershipStatus
{
	EOK_OS_NotOwned = 0 UMETA(DisplayName = "Not Owned"),
	EOK_OS_Owned = 1 UMETA(DisplayName = "Owned"),
};
...
USTRUCT(BlueprintType)
struct FEOK_Ecom_ItemOwnership
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	TEnumAsByte<EEOK_EOwnershipStatus> OwnershipStatus;


	EOS_Ecom_ItemOwnership Ref;
	FEOK_Ecom_ItemOwnership(): Ref()
	{
		Id = FEOK_Ecom_CatalogItemId();
		OwnershipStatus = EOK_OS_NotOwned;
	}

	FEOK_Ecom_ItemOwnership(EOS_Ecom_ItemOwnership InItemOwnership)
	{
		Ref = InItemOwnership;
		Id = InItemOwnership.Id;
		OwnershipStatus = static_cast<EEOK_EOwnershipStatus>(InItemOwnership.OwnershipStatus);
	}
};

USTRUCT(BlueprintType)
struct FEOK_Ecom_SandboxId
{
	GENERATED_BODY()
	...
	FEOK_Ecom_SandboxId(): Value(), Ref(nullptr)
	{
	}
	FEOK_Ecom_SandboxId(EOS_Ecom_SandboxId InSandboxId)
	{
		Ref = InSandboxId;
...
USTRUCT(BlueprintType)
struct FEOK_Ecom_SandboxIdItemOwnership
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	FEOK_Ecom_SandboxId SandboxId;

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	TArray<FEOK_Ecom_CatalogItemId> OwnedCatalogItemIds;

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Ecom Interface")
	int32 OwnedCatalogItemIdsCount;

	FEOK_Ecom_SandboxIdItemOwnership(): OwnedCatalogItemIdsCount(0)
	{
		SandboxId = FEOK_Ecom_SandboxId();
	}

	FEOK_Ecom_SandboxIdItemOwnership(EOS_Ecom_SandboxIdItemOwnership InSandboxIdItemOwnership)
	{
...
UENUM(BlueprintType)
enum EEOK_EFriendsStatus
{
	//The two accounts have no friendship status.
	EOK_FS_NotFriends = 0 UMETA(DisplayName = "Not Friends"),
	...
	EOK_FS_InviteSent = 1 UMETA(DisplayName = "Invite Sent"),
	//The other account has sent a friend invite to the local account. NOTE: EOS_FS_InviteReceived is not returned by EOS_Friends_GetStatus or in EOS_Friends_AddNotifyFriendsUpdate callbacks unless the local account was logged in with the EOS_AS_FriendsManagement authentication scope. Friend invites are managed automatically by the Social Overlay.
	EOK_FS_InviteReceived = 2 UMETA(DisplayName = "Invite Received"),
	//The accounts have accepted friendship.
	EOK_FS_Friends = 3 UMETA(DisplayName = "Friends"),
};

UENUM(BlueprintType)
enum EEOK_ELeaderboardAggregation
{
	//Minimum
	EOK_LA_Min = 0 UMETA(DisplayName = "Min"),
	//Maximum
	EOK_LA_Max = 1 UMETA(DisplayName = "Max"),
	//Sum
	EOK_LA_Sum = 2 UMETA(DisplayName = "Sum"),
	//Latest
	EOK_LA_Latest = 3 UMETA(DisplayName = "Latest"),
};

USTRUCT(BlueprintType)
struct FEOK_Leaderboards_Definition
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Leaderboards Interface")
	TEnumAsByte<EEOK_ELeaderboardAggregation> Aggregation;
	...
	FEOK_Leaderboards_Definition(): LeaderboardId(), StatName(), Aggregation(EEOK_ELeaderboardAggregation::EOK_LA_Min),
	                                StartTime(0), EndTime(0), Ref()
	{
	}

	FEOK_Leaderboards_Definition(EOS_Leaderboards_Definition InLeaderboardDefinition)
	{
		...
		Aggregation = static_cast<EEOK_ELeaderboardAggregation>(InLeaderboardDefinition.Aggregation);
...
USTRUCT(BlueprintType)
struct FEOK_Leaderboards_LeaderboardRecord
{
	GENERATED_BODY()
	...
	FEOK_Leaderboards_LeaderboardRecord(): UserId(), Rank(0), Score(0), UserDisplayName(), Ref()
	{
	}

	FEOK_Leaderboards_LeaderboardRecord(EOS_Leaderboards_LeaderboardRecord InLeaderboardRecord)
	{
...
USTRUCT(BlueprintType)
struct FEOK_Leaderboards_LeaderboardUserScore
{
	GENERATED_BODY()
	...
	FEOK_Leaderboards_LeaderboardUserScore(): UserId(), Score(0), Ref()
	{
	}

	FEOK_Leaderboards_LeaderboardUserScore(EOS_Leaderboards_LeaderboardUserScore InLeaderboardUserScore)
	{
...
USTRUCT(BlueprintType)
struct FEOK_Leaderboards_UserScoresQueryStatInfo
{
	GENERATED_BODY()
	...
	FEOK_Leaderboards_UserScoresQueryStatInfo(): StatName(), Aggregation(EEOK_ELeaderboardAggregation::EOK_LA_Min)
	{
	}
...
USTRUCT(BlueprintType)
struct FEOK_UI_EventId 
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | UI Interface")
	int64 Value;
	
	EOS_UI_EventId Ref;
	
	FEOK_UI_EventId(): Ref(-1)
	{
		Value = -1;
	}
	FEOK_UI_EventId(EOS_UI_EventId InEventId)
	{
		Ref = InEventId;
		Value = InEventId;
	}
...
struct FEOK_LobbyId
{
	...
	FEOK_LobbyId(): Value(), Ref(nullptr)
	{
	}
	FEOK_LobbyId(EOS_LobbyId InLobbyId)
	{
		Ref = InLobbyId;
...
enum EEOK_ELobbyAttributeVisibility
{
	...
	EOK_LAV_Private = 1 UMETA(DisplayName = "Private"),
};
 ...
 */
UENUM(BlueprintType)
enum EEOK_EAttributeType
{
	/** Boolean value (true/false) */
	EOK_AT_BOOL = 0 UMETA(DisplayName = "Bool"),
	/** 64 bit integers */
	EOK_AT_INT64 = 1 UMETA(DisplayName = "Int64"),
	/** Double precision floating point */
	EOK_AT_DOUBLE = 2 UMETA(DisplayName = "Double"),
	/** UTF-8 string */
	EOK_AT_STRING = 3 UMETA(DisplayName = "String"),
};
 ...
 */
USTRUCT(BlueprintType)
struct FEOK_Lobby_AttributeData
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Lobby Interface")
	TEnumAsByte<EEOK_EAttributeType> ValueType;

	EOS_Lobby_AttributeData Ref;

	FEOK_Lobby_AttributeData(): ValueAsInt64(0), bValueAsBool(false), ValueAsDouble(0), ValueType(), Ref()
	{
	}

	FEOK_Lobby_AttributeData(EOS_Lobby_AttributeData InLobbyAttributeData)
	{
		...
		ValueType = static_cast<EEOK_EAttributeType>(InLobbyAttributeData.ValueType);
	}
};
 ...
 */
USTRUCT(BlueprintType)
struct FEOK_Lobby_Attribute
{
	GENERATED_BODY()
	
	/** Key/Value pair describing the attribute */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Lobby Interface")
	FEOK_Lobby_AttributeData Data;

	/** Is this attribute public or private to the lobby and its members */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Lobby Interface")
	TEnumAsByte<EEOK_ELobbyAttributeVisibility> Visibility;
	
	EOS_Lobby_Attribute Ref;
	FEOK_Lobby_Attribute(): Visibility(), Ref()
	{
	}

	FEOK_Lobby_Attribute(EOS_Lobby_Attribute InLobbyAttribute)
	{
		Ref = InLobbyAttribute;
		Data = *InLobbyAttribute.Data;
		Visibility = static_cast<EEOK_ELobbyAttributeVisibility>(InLobbyAttribute.Visibility);
	}
};

USTRUCT(BlueprintType)
struct FEOK_HLobbySearch
{
	GENERATED_BODY()

	EOS_HLobbySearch Ref;

	FEOK_HLobbySearch(): Ref(nullptr)
	{
	}
	FEOK_HLobbySearch(EOS_HLobbySearch InHLobbySearch)
	{
		Ref = InHLobbySearch;
	}
};
...
USTRUCT(BlueprintType)
struct FEOK_HLobbyModification
{
	GENERATED_BODY()

	EOS_HLobbyModification* Ref;
	
	FEOK_HLobbyModification(): Ref(nullptr)
	{
	}
	FEOK_HLobbyModification(EOS_HLobbyModification* InHLobbyModification)
	{
...
USTRUCT(BlueprintType)
struct FEOK_HLobbyDetails
{
	GENERATED_BODY()

	EOS_HLobbyDetails Ref;

	FEOK_HLobbyDetails(): Ref(nullptr)
	{
	}
	FEOK_HLobbyDetails(EOS_HLobbyDetails InHLobbyDetails)
	{
		Ref = InHLobbyDetails;
	}
};
...
UENUM(BlueprintType)
enum EEOK_ELobbyPermissionLevel
{
	/** Anyone can find this lobby as long as it isn't full */
	EOK_LPL_PublicAdvertised = 0 UMETA(DisplayName = "Public Advertised"),
	/** Players who have access to presence can see this lobby */
	EOK_LPL_JoinViaPresence = 1 UMETA(DisplayName = "Join Via Presence"),
	/** Only players with invites registered can see this lobby */
	EOK_LPL_InviteOnly = 2 UMETA(DisplayName = "Invite Only"),
};
 ...
 */
USTRUCT(BlueprintType)
struct FEOK_Lobby_LocalRTCOptions
{
	GENERATED_BODY()
	...
	*/
	...
	FEOK_Lobby_LocalRTCOptions(): Flags(0), bUseManualAudioInput(false), bUseManualAudioOutput(false), bLocalAudioDeviceInputStartsMuted(false)
	{
	}
	FEOK_Lobby_LocalRTCOptions(EOS_Lobby_LocalRTCOptions InLocalRTCOptions)
	{
...
struct FEOK_LobbyDetailsInfo
{
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Lobby Interface")
	FEOK_ProductUserId LobbyOwnerUserId;

	//Permission level of the lobby
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Lobby Interface")
	TEnumAsByte<EEOK_ELobbyPermissionLevel> PermissionLevel;
	...
	FEOK_LobbyDetailsInfo(): LobbyId(), LobbyOwnerUserId(), PermissionLevel(), AvailableSlots(0), MaxMembers(0),
	...
	FEOK_LobbyDetailsInfo(EOS_LobbyDetails_Info InLobbyDetailsInfo)
	{
		Ref = InLobbyDetailsInfo;
		LobbyId = InLobbyDetailsInfo.LobbyId;
		LobbyOwnerUserId = InLobbyDetailsInfo.LobbyOwnerUserId;
		PermissionLevel = static_cast<EEOK_ELobbyPermissionLevel>(InLobbyDetailsInfo.PermissionLevel);
...
USTRUCT(BlueprintType)
struct FEOK_LobbyDetails_MemberInfo
{
	GENERATED_BODY()
	...
	FEOK_LobbyDetails_MemberInfo(): UserId(), Platform(0), bAllowsCrossplay(false), Ref()
	{
	}

	FEOK_LobbyDetails_MemberInfo(EOS_LobbyDetails_MemberInfo InLobbyDetailsMemberInfo)
	{
...
USTRUCT(BlueprintType)
struct FEOK_PlayerDataStorage_FileMetadata
{
	GENERATED_BODY()

	//The total size of the file in bytes (Includes file header in addition to file contents)
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Player Data Storage Interface")
	int32 FileSizeBytes;
	...
	FEOK_PlayerDataStorage_FileMetadata(): FileSizeBytes(0), MD5Hash(), Filename(), LastModifiedTime(0),
	                                       UnencryptedDataSizeBytes(0), Ref()
	{
	}

	FEOK_PlayerDataStorage_FileMetadata(EOS_PlayerDataStorage_FileMetadata InFileMetadata)
	{
		Ref = InFileMetadata;
...
USTRUCT(BlueprintType)
struct FEOK_HPlayerDataStorageFileTransferRequest 
{
	GENERATED_BODY()

	EOS_HPlayerDataStorageFileTransferRequest Ref;

	FEOK_HPlayerDataStorageFileTransferRequest(): Ref(nullptr)
	{
	}
	FEOK_HPlayerDataStorageFileTransferRequest(EOS_HPlayerDataStorageFileTransferRequest InHPlayerDataStorageFileTransferRequest)
	{
 ...
 */
UENUM(BlueprintType)
enum EEOK_Presence_EStatus
{
	/** The status of the account is offline or not known */
	EOK_PS_Offline = 0 UMETA(DisplayName = "Offline"),
	/** The status of the account is online */
	EOK_PS_Online = 1 UMETA(DisplayName = "Online"),
	/** The status of the account is away */
	EOK_PS_Away = 2 UMETA(DisplayName = "Away"),
	/** The status of the account is away, and has been away for a while */
	EOK_PS_ExtendedAway = 3 UMETA(DisplayName = "Extended Away"),
	/** The status of the account is do-not-disturb */
	EOK_PS_DoNotDisturb = 4 UMETA(DisplayName = "Do Not Disturb"),
};
 ...
 */
USTRUCT(BlueprintType)
struct FEOK_Presence_DataRecord
{
	GENERATED_BODY()
	
	/** The name of this data */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Presence Interface")
	FString Key;
	...
	FEOK_Presence_DataRecord(): Key(), Value(), Ref()
	{
	}

	FEOK_Presence_DataRecord(EOS_Presence_DataRecord InPresenceDataRecord)
	{
 ...
 */
USTRUCT(BlueprintType)
struct FEOK_Presence_Info
{
	GENERATED_BODY()

	/** The status of the user */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Presence Interface")
	TEnumAsByte<EEOK_Presence_EStatus> Status;

	/** The Epic Account ID of the user */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Presence Interface")
	FEOK_EpicAccountId UserId;
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Presence Interface")
	FEOK_Presence_DataRecord Record;
	...
	FEOK_Presence_Info(): Status(), UserId(), ProductId(), ProductVersion(), Platform(), RichText(), RecordsCount(0),
	                      Record(), ProductName(), IntegratedPlatform(), Ref()
	{
	}

	FEOK_Presence_Info(EOS_Presence_Info InPresenceInfo)
	{
		Ref = InPresenceInfo;
		Status = static_cast<EEOK_Presence_EStatus>(InPresenceInfo.Status);
...
USTRUCT(BlueprintType)
struct FEOK_HPresenceModification
{
	GENERATED_BODY()

	EOS_HPresenceModification Ref;

	FEOK_HPresenceModification(): Ref(nullptr)
	{
	}
	FEOK_HPresenceModification(EOS_HPresenceModification InHPresenceModification)
	{
...
USTRUCT(BlueprintType)
struct FEOK_PresenceModification_DataRecordId
{
	GENERATED_BODY()
	...
	FEOK_PresenceModification_DataRecordId(): Key(), Ref()
	{
	}

	FEOK_PresenceModification_DataRecordId(EOS_PresenceModification_DataRecordId InPresenceModificationDataRecordId)
	{
 ...
 */
USTRUCT(BlueprintType)
struct FEOK_RTC_ParticipantMetadata
{
	GENERATED_BODY()

	/** The unique key of this metadata item. The max size of the string is EOS_RTC_PARTICIPANTMETADATA_KEY_MAXCHARCOUNT. */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | RTC Interface")
	FString Key;
	...
	FEOK_RTC_ParticipantMetadata(): Key(), Value(), Ref()
	{
	}
	FEOK_RTC_ParticipantMetadata(EOS_RTC_ParticipantMetadata InParticipantMetadata)
	{
...
UENUM(BlueprintType)
enum EEOK_ERTCParticipantStatus
{
	//Participant joined the room
	EOK_RTCPS_Joined = 0 UMETA(DisplayName = "Joined"),
	//Participant left the room
	EOK_RTCPS_Left = 1 UMETA(DisplayName = "Left"),
};

USTRUCT(BlueprintType)
struct FEOK_Sanctions_PlayerSanction
{
	GENERATED_BODY()

	//The POSIX timestamp when the sanction was placed
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Sanctions Interface")
	int64 TimePlaced;
	...
	FEOK_Sanctions_PlayerSanction(): TimePlaced(0), TimeExpires(0), Action(), ReferenceId()
	{
	}
	FEOK_Sanctions_PlayerSanction(EOS_Sanctions_PlayerSanction InPlayerSanction)
	{
...
UENUM(BlueprintType)
enum EEOK_ESanctionAppealReason
{
	//Not used
	EOK_SAR_Invalid = 0 UMETA(DisplayName = "Invalid"),
	//Incorrectly placed sanction
	EOK_SAR_IncorrectSanction = 1 UMETA(DisplayName = "Incorrect Sanction"),
	//The account was compromised, typically this means stolen
	EOK_SAR_CompromisedAccount = 2 UMETA(DisplayName = "Compromised Account"),
	//The punishment is considered too severe by the user
	EOK_SAR_UnfairPunishment = 3 UMETA(DisplayName = "Unfair Punishment"),
	//The user admits to rulebreaking, but still appeals for forgiveness
	EOK_SAR_AppealForForgiveness = 4 UMETA(DisplayName = "Appeal For Forgiveness"),
};

/** All possible states of an existing named session */
UENUM(BlueprintType)
enum EEOK_EOnlineSessionState
{
	...
	EOK_OSS_InProgress = 4,
	/** The session is still valid, but the session is no longer being played (post match lobby) */
	EOK_OSS_Ending = 5,
	/** The session is closed and any stats committed */
	EOK_OSS_Ended = 6,
	/** The session is being destroyed */
	EOK_OSS_Destroying = 7
};

UENUM(BlueprintType)
enum EEOK_EOnlineSessionPermissionLevel
{
	/** Anyone can find this session as long as it isn't full */
	EOK_OSPF_PublicAdvertised = 0 UMETA(DisplayName = "Public Advertised"),
	/** Players who have access to presence can see this session */
	EOK_OSPF_JoinViaPresence = 1 UMETA(DisplayName = "Join Via Presence"),
	/** Only players with invites registered can see this session */
	EOK_OSPF_InviteOnly = 2 UMETA(DisplayName = "Invite Only"),
};

USTRUCT(BlueprintType)
struct FEOK_SessionDetails_Settings
{
	GENERATED_BODY()

	/** The main indexed parameter for this session, can be any string (i.e. "Region:GameMode") */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Sessions Interface")
	FString BucketId;
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Sessions Interface")
	TEnumAsByte<EEOK_EOnlineSessionPermissionLevel> PermissionLevel;
	...
	*/
	...
	FEOK_SessionDetails_Settings()
	{
		BucketId = "";
		NumPublicConnections = 0;
		bAllowJoinInProgress = false;
		PermissionLevel = EEOK_EOnlineSessionPermissionLevel::EOK_OSPF_PublicAdvertised;
		bAllowInvites = false;
		bSanctionsEnabled = false;
		AllowedPlatformIds.Empty();
	}
	FEOK_SessionDetails_Settings(EOS_SessionDetails_Settings InSessionDetailsSettings)
	{
		...
		PermissionLevel = static_cast<EEOK_EOnlineSessionPermissionLevel>(InSessionDetailsSettings.PermissionLevel);
...
USTRUCT(BlueprintType)
struct FEOK_SessionDetails_Info
{
	GENERATED_BODY()
	...
	FEOK_SessionDetails_Info()
	{
		SessionId = "";
		HostAddress = "";
		NumOpenPublicConnections = 0;
		Settings = FEOK_SessionDetails_Settings();
		OwnerUserId = FEOK_ProductUserId();
		OwnerServerClientId = "";
	}
	FEOK_SessionDetails_Info(EOS_SessionDetails_Info InSessionDetailsInfo)
	{
...
USTRUCT(BlueprintType)
struct FEOK_ActiveSession_Info
{
	GENERATED_BODY()
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Sessions Interface")
	TEnumAsByte<EEOK_EOnlineSessionState> State;

	/** Session details */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Sessions Interface")
	FEOK_SessionDetails_Info SessionDetails;

	FEOK_ActiveSession_Info()
	{
		SessionName = "";
		LocalUserId = FEOK_ProductUserId();
		State = EEOK_EOnlineSessionState::EOK_OSS_NoSession;
		SessionDetails = FEOK_SessionDetails_Info();
	}
	FEOK_ActiveSession_Info(EOS_ActiveSession_Info InActiveSessionInfo)
	{
		SessionName = FString(UTF8_TO_TCHAR(InActiveSessionInfo.SessionName));
		LocalUserId = InActiveSessionInfo.LocalUserId;
		State = static_cast<EEOK_EOnlineSessionState>(InActiveSessionInfo.State);
		SessionDetails = *InActiveSessionInfo.SessionDetails;
	}
};

USTRUCT(BlueprintType)
struct FEOK_HActiveSession
{
	GENERATED_BODY()

	EOS_HActiveSession Ref;

	FEOK_HActiveSession(): Ref(nullptr)
	{
	}
	FEOK_HActiveSession(EOS_HActiveSession InHActiveSession)
	{
...
USTRUCT(BlueprintType)
struct FEOK_HSessionDetails
{
	GENERATED_BODY()

	EOS_HSessionDetails Ref;

	FEOK_HSessionDetails(): Ref()
	{
	}
	FEOK_HSessionDetails(EOS_HSessionDetails InHSessionDetails)
	{
...
UENUM(BlueprintType)
enum EOK_ESessionAttributeAdvertisementType
{
	/** Don't advertise via the online service */
	EOK_SAAT_DontAdvertise = 0,
	/** Advertise via the online service only */
	EOK_SAAT_Advertise = 1
};

USTRUCT(BlueprintType)
struct FEOK_Sessions_AttributeData
{
	GENERATED_BODY()
	...
	FEOK_Sessions_AttributeData(): Key(), ValueAsInt64(0), ValueAsString(), bValueAsBool(false), ValueAsDouble(0.0), ValueType()
	{
	}
	FEOK_Sessions_AttributeData(EOS_Sessions_AttributeData InAttributeData)
	{
		...
		ValueType = static_cast<EEOK_EAttributeType>(InAttributeData.ValueType);
	}
...
USTRUCT(BlueprintType)
struct FEOK_SessionDetails_Attribute
{
	GENERATED_BODY()

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Sessions Interface")
	FEOK_Sessions_AttributeData Data;

	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | Sessions Interface")
	TEnumAsByte<EOK_ESessionAttributeAdvertisementType> ValueType;

	FEOK_SessionDetails_Attribute(): Data(), ValueType()
	{
	}
	FEOK_SessionDetails_Attribute(EOS_SessionDetails_Attribute InSessionDetailsAttribute)
	{
		Data = *InSessionDetailsAttribute.Data;
		ValueType = static_cast<EOK_ESessionAttributeAdvertisementType>(InSessionDetailsAttribute.AdvertisementType);
	}
};

USTRUCT(BlueprintType)
struct FEOK_HSessionModification
{
	GENERATED_BODY()

	EOS_SessionModificationHandle* Ref;

	FEOK_HSessionModification(): Ref(nullptr)
	{
	}
	FEOK_HSessionModification(EOS_SessionModificationHandle* InHSessionModification)
	{
...
USTRUCT(BlueprintType)
struct FEOK_HSessionSearch
{
	GENERATED_BODY()

	EOS_HSessionSearch* Ref;

	FEOK_HSessionSearch(): Ref(nullptr)
	{
	}
	FEOK_HSessionSearch(EOS_HSessionSearch* InHSessionSearch)
	{
...
struct FEOK_Stats_Stat
{
	...
	FEOK_Stats_Stat(): Name(), StartTime(0), EndTime(0), Value(0)
	{
	}

	FEOK_Stats_Stat(EOS_Stats_Stat InStat)
	{
...
UENUM(BlueprintType)
enum EEOK_UI_ENotificationLocation
{
	EOK_UNL_TopLeft,
	EOK_UNL_TopRight,
	EOK_UNL_BottomLeft,
...
USTRUCT(BlueprintType)
struct FEOK_UserInfo_BestDisplayName
{
	GENERATED_BODY()

	//The Epic Account ID of the user
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | User Info Interface")
	FEOK_EpicAccountId UserId;
	...
	FEOK_UserInfo_BestDisplayName(): UserId(), DisplayName(), DisplayNameSanitized(), Nickname(), PlatformType(0)
	{
	}
	FEOK_UserInfo_BestDisplayName(EOS_UserInfo_BestDisplayName InBestDisplayName)
	{
...
USTRUCT(BlueprintType)
struct FEOK_UserInfo_ExternalUserInfo
{
	GENERATED_BODY()
	...
	FEOK_UserInfo_ExternalUserInfo(): AccountType(), AccountId(), DisplayName(), DisplayNameSanitized()
	{
	}
	FEOK_UserInfo_ExternalUserInfo(EOS_UserInfo_ExternalUserInfo InExternalUserInfo)
	{
		AccountType = static_cast<EEOK_EExternalAccountType>(InExternalUserInfo.AccountType);
...
struct FEOK_UserInfo
{
	...
	FEOK_UserInfo(): UserId(), Country(), DisplayName(), PreferredLanguage(), Nickname(), DisplayNameSanitized()
	{
	}
	FEOK_UserInfo(EOS_UserInfo InUserInfo)
	{
...
USTRUCT(BlueprintType)
struct FEOK_P2P_SocketId
{
	GENERATED_BODY()

	/** A name for the connection. Must be a NULL-terminated string of between 1-32 alpha-numeric characters (A-Z, a-z, 0-9, '-', '_', ' ', '+', '=', '.') */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | P2P Interface")
	FString SocketName;

	FEOK_P2P_SocketId(): SocketName()
	{
	}
	FEOK_P2P_SocketId(EOS_P2P_SocketId InSocketId)
	{
...
UENUM(BlueprintType)
enum EEOK_EConnectionClosedReason
{
...
USTRUCT(BlueprintType)
struct FEOK_P2P_PacketQueueInfo
{
	GENERATED_BODY()
	...
	FEOK_P2P_PacketQueueInfo(): IncomingPacketQueueMaxSizeBytes(0), IncomingPacketQueueCurrentSizeBytes(0), IncomingPacketQueueCurrentPacketCount(0),
	                           OutgoingPacketQueueMaxSizeBytes(0), OutgoingPacketQueueCurrentSizeBytes(0), OutgoingPacketQueueCurrentPacketCount(0)
	{
	}
	FEOK_P2P_PacketQueueInfo(EOS_P2P_PacketQueueInfo InPacketQueueInfo)
	{
...
struct FEOK_RTC_Option
{
	...
	FEOK_RTC_Option(): Key(), Value()
	{
	}
	FEOK_RTC_Option(EOS_RTC_Option InOption)
	{
...
USTRUCT(BlueprintType)
struct FEOK_RTCAdmin_UserToken
{
	GENERATED_BODY()

	//The Product User ID for the user who owns this user token
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | RTC Admin Interface")
	FEOK_ProductUserId ProductUserId;

	//Access token to enable a user to join a room
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | RTC Admin Interface")
	FString Token;

	FEOK_RTCAdmin_UserToken(): ProductUserId(), Token()
	{
	}
	FEOK_RTCAdmin_UserToken(EOS_RTCAdmin_UserToken InUserToken)
	{
...
USTRUCT(BlueprintType)
struct FEOK_RTCAudio_AudioBuffer
{
	GENERATED_BODY()

	/** Pointer to the data with the interleaved audio frames in signed 16 bits format. */
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Epic Online Services-Kit V2 | SDK Functions | RTC Audio Interface")
	TArray<int32> Data;
 ...
 */
	...
	FEOK_RTCAudio_AudioBuffer(): Data(), FramesCount(0), SampleRate(0), NumChannels(0)
	{
	}
	FEOK_RTCAudio_AudioBuffer(EOS_RTCAudio_AudioBuffer InAudioBuffer)
	{
		Data.Empty();
...
UENUM(BlueprintType)
enum EEOK_ERTCAudioInputStatus
{
	EOK_RTCAIS_Idle = 0 UMETA(DisplayName = "Idle"),
	EOK_RTCAIS_Recording = 1 UMETA(DisplayName = "Recording"),
	EOK_RTCAIS_RecordingSilent = 2 UMETA(DisplayName = "Recording Silent"),
	EOK_RTCAIS_RecordingDisconnected = 3 UMETA(DisplayName = "Recording Disconnected"),
	EOK_RTCAIS_Failed = 4 UMETA(DisplayName = "Failed"),
};

UENUM(BlueprintType)
enum EEOK_ERTCAudioOutputStatus
{
	EOK_RTCAOS_Idle = 0 UMETA(DisplayName = "Idle"),
	EOK_RTCAOS_Playing = 1 UMETA(DisplayName = "Playing"),
	EOK_RTCAOS_Failed = 2 UMETA(DisplayName = "Failed"),
};

UENUM(BlueprintType)
enum EEOK_ERTCAudioStatus
{
	EOK_RTCAS_Unsupported = 0 UMETA(DisplayName = "Unsupported"),
	EOK_RTCAS_Enabled = 1 UMETA(DisplayName = "Enabled"),
	//Audio disabled
	EOK_RTCAS_Disabled = 2 UMETA(DisplayName = "Disabled"),
	//Audio disabled by the administrator
	EOK_RTCAS_DisabledByAdmin = 3 UMETA(DisplayName = "Disabled By Admin"),
	//Audio channel is disabled temporarily for both sending and receiving
	EOK_RTCAS_NotListeningDisabled = 4 UMETA(DisplayName = "Not Listening Disabled"),
};

USTRUCT(BlueprintType)
struct FEOK_RTCAudio_InputDeviceInformation
{
	GENERATED_BODY()
	...
	FEOK_RTCAudio_InputDeviceInformation(): bDefaultDevice(false), DeviceId(), DeviceName(), Ref()
	{
	}

	FEOK_RTCAudio_InputDeviceInformation(EOS_RTCAudio_InputDeviceInformation InInputDeviceInformation)
	{
...
USTRUCT(BlueprintType)
struct FEOK_RTCAudio_OutputDeviceInformation
{
	GENERATED_BODY()
	...
	FEOK_RTCAudio_OutputDeviceInformation(): bDefaultDevice(false), DeviceId(), DeviceName(), Ref()
	{
	}

	FEOK_RTCAudio_OutputDeviceInformation(EOS_RTCAudio_OutputDeviceInformation InOutputDeviceInformation)
	{
...
UENUM(BlueprintType)
enum EEOK_ERTCDataStatus
{
	EOK_RTCDS_Unsupported = 0 UMETA(DisplayName = "Unsupported"),
	EOK_RTCDS_Enabled = 1 UMETA(DisplayName = "Enabled"),
	//Data disabled
	EOK_RTCDS_Disabled = 2 UMETA(DisplayName = "Disabled"),
};

DECLARE_LOG_CATEGORY_EXTERN(LogEOK, Verbose, All);
UCLASS()
class OnlineSubsystemEOK_API UEOK_SharedFunctionFile : public UObject
{
	GENERATED_BODY()

public:
	
	UFUNCTION(BlueprintPure, Category = "Epic Online Services-Kit V2 | SDK Functions | Shared Functions")
