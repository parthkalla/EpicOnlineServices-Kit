 ...
 */
class OnlineSubsystemEOK_API FOnlineSubsystemEOS : 
...
// IOnlineSubsystemEOS
	...
	virtual IEOKPlatformHandlePtr GetEOSPlatformHandle() const override { return EOSPlatformHandle; };
...
// FTSTickerObjectBase
	...
	/** EOS handles */
	IEOKPlatformHandlePtr EOSPlatformHandle;
	...
	TSharedPtr<FSocketSubsystemEOK, ESPMode::ThreadSafe> SocketSubsystem;
...
public:
	explicit FOnlineSubsystemEOS(FName InInstanceName) :
		FOnlineSubsystemImpl("EOK", InInstanceName)
	{
	}
