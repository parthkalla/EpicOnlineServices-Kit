...
// IOnlineIdentity Interface
	...
	static EEOK_EExternalCredentialType GetExternalCredentialType(const FString& Type);
	static EEOK_ELoginCredentialType GetLoginCredentialType(const FString& Type);
