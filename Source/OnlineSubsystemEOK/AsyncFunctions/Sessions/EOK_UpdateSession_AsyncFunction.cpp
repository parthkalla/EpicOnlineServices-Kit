...
#include "EOK_UpdateSession_AsyncFunction.h"


UEOK_UpdateSession_AsyncFunction* UEOK_UpdateSession_AsyncFunction::UpdateEOKSessions(UObject* WorldContextObject,
	TMap<FString, FEOKAttribute> SessionSettings, TArray<FEOK_MemberSpecificAttribute> MemberSettings, FName SessionName,
...
{
	UEOK_UpdateSession_AsyncFunction* UpdateSession = NewObject<UEOK_UpdateSession_AsyncFunction>();
...
void UEOK_UpdateSession_AsyncFunction::OnUpdateSessionComplete(FName Name, bool bArg)
{
	if (bArg)
	{
		OnSuccess.Broadcast();
...
void UEOK_UpdateSession_AsyncFunction::Activate()
{
	Super::Activate();
	if (const IOnlineSubsystem* SubsystemRef = Online::GetSubsystem(this->GetWorld()))
	{
		if (const IOnlineSessionPtr SessionPtrRef = SubsystemRef->GetSessionInterface())
		{
			...
			SessionPtrRef->OnUpdateSessionCompleteDelegates.AddUObject(
				this, &UEOK_UpdateSession_AsyncFunction::OnUpdateSessionComplete);
