...
#include "EOK_GetLeaderboardForUserIds.generated.h"
...
struct FEOKExtendedLeaderboardValue
{
	GENERATED_BODY()
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FGetUserIdLeaderboardResult, const TArray<FEOKExtendedLeaderboardValue>&, LeaderboardValues);


UCLASS()
class OnlineSubsystemEOK_API UEOK_GetLeaderboardForUserIds : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, DisplayName = "Get EOK Leaderboard For User Ids", meta = (BlueprintInternalUseOnly = "true"), Category = "Epic Online Services-Kit V2 || Statistics")
	static UEOK_GetLeaderboardForUserIds* GetEOKLeaderboardForUserIds(TArray<FString> TargetProductUserIds, FString LocalProductUserId, bool UseTime, FDateTime StartTime, FDateTime EndTime, ELeaderboardAggregation AggregationType, FString StatName);
