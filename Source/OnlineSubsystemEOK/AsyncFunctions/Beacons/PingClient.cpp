...
bool APingClient::ConnectToHost(FString Address, int32 Port, const bool bPortOverride, FEOK_PingComplete Ref)
{
	OnPingComplete = Ref;
...
bool APingClient::ConnectToSession(FBlueprintSessionResult SearchResult, FEOK_PingComplete Ref)
{
	OnPingComplete = Ref;
