...
#include "EOK_GetOffers_AsyncFunction.h"
...
void UEOK_GetOffers_AsyncFunction::Activate()
{
	GetOffers();
	Super::Activate();
}

void UEOK_GetOffers_AsyncFunction::GetOffers()
{
...
UEOK_GetOffers_AsyncFunction* UEOK_GetOffers_AsyncFunction::GetEOKOffers()
{
	UEOK_GetOffers_AsyncFunction* BlueprintNode = NewObject<UEOK_GetOffers_AsyncFunction>();
