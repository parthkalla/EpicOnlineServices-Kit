...
#include "EOK_GetPlayerData_AsyncFunction.generated.h"

DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FGetDataResult, bool, bWasSuccess, const TArray<uint8>&,SavedData);

UCLASS()
class OnlineSubsystemEOK_API UEOK_GetPlayerData_AsyncFunction : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, DisplayName="Get EOK Player Storage", meta = (BlueprintInternalUseOnly = "true"), Category="Epic Online Services-Kit V2 || Storage")
	static UEOK_GetPlayerData_AsyncFunction* GetPlayerData( FString FileName);
