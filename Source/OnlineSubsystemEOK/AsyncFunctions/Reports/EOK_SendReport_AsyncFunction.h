...
#include "EOK_SendReport_AsyncFunction.generated.h"
...
UCLASS()
class OnlineSubsystemEOK_API UEOK_SendReport_AsyncFunction : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
public:
	...
	//Functions
	UFUNCTION(BlueprintCallable, DisplayName = "Send EOK Player Report", meta = (BlueprintInternalUseOnly = "true"), Category = "Epic Online Services-Kit V2 || Reports")
	static UEOK_SendReport_AsyncFunction* SendEOKPlayerReportAsyncFunction(FString LocalReporterPUID, FString TargetPlayerPUID, E_PlayerReportCategory ReportCategory, FString Message);
