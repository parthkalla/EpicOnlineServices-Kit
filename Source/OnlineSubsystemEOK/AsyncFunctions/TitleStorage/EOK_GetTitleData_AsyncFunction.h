...
#include "EOK_GetTitleData_AsyncFunction.generated.h"
 ...
 */
UCLASS()
class OnlineSubsystemEOK_API UEOK_GetTitleData_AsyncFunction : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	...
	*/
	UFUNCTION(BlueprintCallable, DisplayName="Get EOK Title Data", meta = (BlueprintInternalUseOnly = "true"), Category="Epic Online Services-Kit V2 || Storage")
	static UEOK_GetTitleData_AsyncFunction* GetTitleData( FString FileName);
