...
#include "EOK_GetExternalAccountsFromPUID.generated.h"
...
UCLASS()
class OnlineSubsystemEOK_API UEOK_GetExternalAccountsFromPUID : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
	
public:

	UFUNCTION(BlueprintCallable, DisplayName = "Get External Accounts From Product User Ids", meta = (BlueprintInternalUseOnly = "true"), Category = "Epic Online Services-Kit V2 || UserInfo")
	static UEOK_GetExternalAccountsFromPUID* EOKGetExternalAccountsFromPuid(TArray<FString> TargetProductUserIds, FString LocalProductUserId);
