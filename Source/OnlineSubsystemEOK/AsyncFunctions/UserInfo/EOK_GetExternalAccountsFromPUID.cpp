...
#include "EOK_GetExternalAccountsFromPUID.h"
...
UEOK_GetExternalAccountsFromPUID* UEOK_GetExternalAccountsFromPUID::EOKGetExternalAccountsFromPuid(TArray<FString> TargetProductUserIds, FString LocalProductUserId)
{
	UEOK_GetExternalAccountsFromPUID* EOK_GetPUIDFromEpicId_Obj = NewObject<UEOK_GetExternalAccountsFromPUID>();

	EOK_GetPUIDFromEpicId_Obj->Var_TargetUserIds = TargetProductUserIds;
	EOK_GetPUIDFromEpicId_Obj->Var_LocalProductUserId = LocalProductUserId;

	return EOK_GetPUIDFromEpicId_Obj;
}

void UEOK_GetExternalAccountsFromPUID::GetExternalAccountsFromPuid()
{
...
void UEOK_GetExternalAccountsFromPUID::OnQueryProductUserIdMappingsComplete(const EOS_Connect_QueryProductUserIdMappingsCallbackInfo* Data)
{
	if (Data->ResultCode == EOS_EResult::EOS_Success)
	{
		if (UEOK_GetExternalAccountsFromPUID* GetPUIDFromEpicId = static_cast<UEOK_GetExternalAccountsFromPUID*>(Data->ClientData))
		{
...
void UEOK_GetExternalAccountsFromPUID::QueryProductUserIdMappingsSuccess()
{
	if (IOnlineSubsystem* OnlineSub = IOnlineSubsystem::Get())
	{
		if (FOnlineSubsystemEOS* EOSRef = static_cast<FOnlineSubsystemEOS*>(OnlineSub))
...
void UEOK_GetExternalAccountsFromPUID::QueryProductUserIdMappingsFailure()
{
	TArray<FProductUserIdAndExternalAccountIds> EmptyProductUserIdAndEpicId;
...
void UEOK_GetExternalAccountsFromPUID::Activate()
{
