...
#include "EOK_ExportTicketUserData_Async.generated.h"
...
UCLASS()
class OnlineSubsystemEOK_API UEOK_ExportTicketUserData_Async : public UBlueprintAsyncActionBase
{
    GENERATED_BODY()
...
public:
    ...
    UFUNCTION(BlueprintCallable, DisplayName = "Export EOK Support Ticket Data", meta = (BlueprintInternalUseOnly = "true"), Category = "Epic Online Services-Kit V2 | Support Tickets")
    static UEOK_ExportTicketUserData_Async* ExportEOKTicketDataAsyncFunction(FString Email);
