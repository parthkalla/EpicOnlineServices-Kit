...
UCLASS()
class EOKLoginMethods_API UBFL_GooglePlayGames : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Epic Online Services-Kit V2|Google Play Games|SignIn")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Epic Online Services-Kit V2|Google Play Games|Achievements")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Epic Online Services-Kit V2|Google Play Games|Leaderboards")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Epic Online Services-Kit V2|Google Play Games|Friends")
	 ...
	 */
	UFUNCTION(BlueprintCallable, Category = "Epic Online Services-Kit V2|Google Play Games|Events")
