 ...
 */
UCLASS()
class EOKLoginMethods_API UGPGS_GetPlayerStats : public UBlueprintAsyncActionBase
{
	GENERATED_BODY()
...
public:
	 ...
	 */
	UFUNCTION(BlueprintCallable, meta=(BlueprintInternalUseOnly="true", WorldContext="WorldContextObject"), Category="Epic Online Services-Kit V2|Google Play Games|PlayerStats")
