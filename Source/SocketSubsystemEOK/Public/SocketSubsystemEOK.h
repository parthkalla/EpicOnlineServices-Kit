...
#include "SocketSubsystemEOKUtils.h"
...
class SocketSubsystemEOK_API FSocketSubsystemEOK
	: public ISocketSubsystem
{
public:
	FSocketSubsystemEOK(IEOKPlatformHandlePtr InPlatformHandle, ISocketSubsystemEOSUtilsPtr InUtils);
	virtual ~FSocketSubsystemEOK();
...
//~ End ISocketSubsystem Interface
	 ...
	 * @return The FSocketSubsystemEOK instance associated with InWorld
	 */
	FSocketSubsystemEOK* GetSocketSubsystemForWorld(UWorld* InWorld);

private:
	/** Removes the FSocketSubsystemEOK instance from SocketSubsystemEOSInstances and all related entries from SocketSubsystemEOSPerWorldMap */
...
private:
	...
	/** Static array of all instances of FSocketSubsystemEOK running concurrently (can be more than one in PIE) */
	static TArray<FSocketSubsystemEOK*> SocketSubsystemEOSInstances;

	/** Static map of world to corresponding FSocketSubsystemEOK instance */
	static TMap<UWorld*, FSocketSubsystemEOK*> SocketSubsystemEOSPerWorldMap;
};
