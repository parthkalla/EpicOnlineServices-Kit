...
class SocketSubsystemEOK_API FSocketEOS
	: public FSocket
{
public:
	FSocketEOS(FSocketSubsystemEOK& SocketSubsystem, const FString& InSocketDescription);
	virtual ~FSocketEOS();
...
private:
	...
	FSocketSubsystemEOK& SocketSubsystem;
	...
	typedef TEOKGlobalCallback<EOS_P2P_OnIncomingConnectionRequestCallback, EOS_P2P_OnIncomingConnectionRequestInfo, FCallbackBase> FConnectNotifyCallback;
	typedef TEOKGlobalCallback<EOS_P2P_OnRemoteConnectionClosedCallback, EOS_P2P_OnRemoteConnectionClosedInfo, FCallbackBase> FClosedNotifyCallback;
#else
	typedef TEOKGlobalCallback<EOS_P2P_OnIncomingConnectionRequestCallback, EOS_P2P_OnIncomingConnectionRequestInfo> FConnectNotifyCallback;
	typedef TEOKGlobalCallback<EOS_P2P_OnRemoteConnectionClosedCallback, EOS_P2P_OnRemoteConnectionClosedInfo> FClosedNotifyCallback;
#endif
