...
#include "NetConnectionEOK.generated.h"

UCLASS(Transient, Config=Engine)
class SocketSubsystemEOK_API UNetConnectionEOK
	: public UIpConnection
{
	GENERATED_BODY()

public:
	explicit UNetConnectionEOK(const FObjectInitializer& ObjectInitializer);
