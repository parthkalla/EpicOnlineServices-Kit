// Restored from original EOSKitSanctions module
...
EEOSResult UEOSKitSanctionsSubsystem::CreatePlayerSanctionAppeal(const FEOSKitProductUserId& LocalUserId, const FString& ReferenceId, EEOSKitSanctionAppealReason Reason)
{
	EOS_HSanctions SanctionsHandle = GetSanctionsHandle();
	if (!SanctionsHandle)
	{
