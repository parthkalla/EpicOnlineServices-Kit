...
class EOKVoiceChat_API FEOSVoiceChatFactory : public IModularFeature, public FSelfRegisteringExec
{
public:
	...
	IVoiceChatPtr CreateInstanceWithPlatform(const IEOKPlatformHandlePtr& PlatformHandle);
