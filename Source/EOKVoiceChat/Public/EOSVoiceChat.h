...
EOKVoiceChat_API const TCHAR* EOK_LexToString(EOS_ERTCAudioInputStatus Status);
...
class EOKVoiceChat_API FEOKVoiceChatDelegates
{
public:
...
{
public:
	FEOSVoiceChat(IEOSSDKManager& InSDKManager, const IEOKPlatformHandlePtr& PlatformHandle);
	...
	IEOKPlatformHandlePtr GetPlatformHandle() const { return EosPlatformHandle; }
...
protected:
	...
	IEOKPlatformHandlePtr EosPlatformHandle = nullptr;
	virtual IEOKPlatformHandlePtr EOSPlatformCreate(EOS_Platform_Options& PlatformOptions);
