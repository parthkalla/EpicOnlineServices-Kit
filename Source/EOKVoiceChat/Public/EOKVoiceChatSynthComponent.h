...
#include "EOKVoiceChatSynthComponent.generated.h"

/**
 * EOK Voice Chat synth Component is used by the EOSVoiceChat System, when attached to a player pawn it will stream audio from the EOSVoiceChatUser allowing the use of spatialization and other audio features
 */

UCLASS(ClassGroup = Synth, meta = (BlueprintSpawnableComponent))
class EOKVoiceChat_API UEOKVoiceChatSynthComponent : public USynthComponent
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Epic Online Services-Kit V2|Voice Settings")
