...
#include "EOKSettings.generated.h"
...
UCLASS(Deprecated)
class UDEPRECATED_EOKArtifactSettings :
	public UDataAsset
{
	GENERATED_BODY()

public:
	UDEPRECATED_EOKArtifactSettings()
	{
	}
};
...
UENUM(BlueprintType)
enum EEOK_FallbackForAutoLoginType
{
	/** No fallback */
...
UENUM(BlueprintType)
enum EEOK_LoginFlags_LocalForSettings
{
...
UENUM(BlueprintType)
enum EEOK_BuildConfiguration
{
	/** Unknown build configuration. */
	EOK_UnknownBuild = 0 UMETA(DisplayName = "Unknown"),

	/** Debug build. */
	EOK_Debug = 1 UMETA(DisplayName = "Debug"),

	/** DebugGame build. */
	EOK_DebugGame = 2 UMETA(DisplayName = "DebugGame"),

	/** Development build. */
	EOK_Development = 3 UMETA(DisplayName = "Development"),

	/** Shipping build. */
	EOK_Shipping = 4 UMETA(DisplayName = "Shipping"),

	/** Test build. */
	EOK_Test = 5 UMETA(DisplayName = "Test"),
};

UCLASS(Config=Engine, DefaultConfig)
class EpicOnlineServicesKitV2_API UEOKSettings :
...
public:
	...
	/** This will automatically setup Epic Online Services-Kit V2.
	 *
	 * Restart the editor after changing this value.
	 */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category="Epic Online Services-Kit V2 Settings")
	bool bAutomaticallySetupEOK;
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category="Epic Online Services-Kit V2 Settings", meta = (EditCondition = "bEnableGooglePlayGames"))
	...
	TEnumAsByte<EEOK_AutoLoginType> AutoLoginType;

	/** If the AutoLoginType fails, this will be used as a fallback */
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category="EOS Settings|Login Settings|Auto Login")
	TEnumAsByte<EEOK_FallbackForAutoLoginType> FallbackForAutoLoginType;
	...
	TArray<TEnumAsByte<EEOK_LoginFlags_LocalForSettings>> LoginFlags = {EEOK_LoginFlags_LocalForSettings::EOS_AS_BasicProfile, EEOK_LoginFlags_LocalForSettings::EOS_AS_FriendsList, EEOK_LoginFlags_LocalForSettings::EOS_AS_Presence};
	...
	*/
	...
	TEnumAsByte<EEOK_BuildConfiguration> OneClick_BuildConfiguration;
